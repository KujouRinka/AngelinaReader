# This file is copy of https://github.com/liblouis/liblouis/blob/master/python/louis/__init__.py.in
#-------------------------------------------------------------------------------------------------
#
...
loader, _functype = cdll, CFUNCTYPE    
liblouis = _loader[str(Path(__file__).parent / "liblouis.dll")]
